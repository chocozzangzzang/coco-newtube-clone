...
export const videosRouter = createTRPCRouter({
    ...
    revalidate: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            // TODO : Pontentially find a way to revalidate trackID and trackStatus as well
    ...
    restoreThumbnail: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const uplodadedThumbnail = await utpapi.uploadFilesFromUrl(tempThumbnailUrl);
            
            if(!uplodadedThumbnail.data) {
                throw new TRPCError({ code : "INTERNAL_SERVER_ERROR" });
            }

            const { key : thumbnailKey, url : thumbnailUrl } = uplodadedThumbnail.data; 
